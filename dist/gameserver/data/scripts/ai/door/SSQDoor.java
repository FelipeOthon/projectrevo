...
{
	private static final Territory room1 = new Territory(0).add(new Rectangle(-89696, 217741, -88858, 218085).setZmin(-7520).setZmax(-7320));
	private static final Territory room2 = new Territory(0).add(new Rectangle(-88773, 220765, -88429, 219596).setZmin(-7520).setZmax(-7320));
	private static final Territory room3 = new Territory(0).add(new Rectangle(-87485, 220463, -86501, 220804).setZmin(-7520).setZmax(-7320));
	private static final Territory room4 = new Territory(0).add(new Rectangle(-85646, 219054, -84787, 219408).setZmin(-7520).setZmax(-7320));
	private static final Territory room5 = new Territory(0).add(new Rectangle(-87739, 216646, -87159, 217842).setZmin(-7520).setZmax(-7320));
	...
	public void onEvtTwiceClick(final Player player)
	{
		...
		{
			case 17240102:
				for(NpcInstance n : GameObjectsStorage.getNpcs())
