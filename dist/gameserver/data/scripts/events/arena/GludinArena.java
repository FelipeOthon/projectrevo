...
public class GludinArena extends ArenaTemplate
{
	...
	{
		if(GludinArena._instance == null)
			GludinArena._instance = new GludinArena();
		return GludinArena._instance;
	}
	...
	public void loadArena()
	{
		...
		_zone = ZoneManager.getInstance().getZoneByIndex(Zone.ZoneType.battle_zone, 2, true);
	...
	public String DialogAppend_17220015(final Integer val)
	{
		if(val != 0)
			return "";
		final Player player = getSelf();
		if(player.isGM())
			return HtmCache.getInstance().getHtml("scripts/events/arena/17220015.html", player) + HtmCache.getInstance().getHtml("scripts/events/arena/17220015-4.html", player);
		return HtmCache.getInstance().getHtml("scripts/events/arena/17220015.html", player);
	}

	public String DialogAppend_17220016(final Integer val)
	{
