...
public class _619_RelicsOfTheOldEmpire extends Quest implements ScriptFile
{
	...
	public _619_RelicsOfTheOldEmpire()
	{
		...
		this.addKillId(_619_RelicsOfTheOldEmpire.drops.keySet());
		addQuestItem(new int[] { 7254 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equals("explorer_ghost_a_q0619_09.htm"))
		{
			...
			st.giveItems(_619_RelicsOfTheOldEmpire.Recipes[Rnd.get(_619_RelicsOfTheOldEmpire.Recipes.length)] + (Config.ALT_100_RECIPES_S ? 1 : 0), 1L);
	...
	public String onKill(final NpcInstance npc, final QuestState st)
	{
		...
		if(Broken_Relic_Part_chance == null)
			return null;
		st.giveItems(7254, (long) (Config.RATE_QUESTS_DROP * AddonsConfig.getQuestDropRates(this)));
		if(npcId > 20000)
	...
	static
	{
		(drops = new HashMap<Integer, Integer>()).put(18120, 138);
