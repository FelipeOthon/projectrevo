...
public class _168_DeliverSupplies extends Quest implements ScriptFile
{
	...
	public _168_DeliverSupplies()
	{
		...
		this.addTalkId(new int[] { 30349 });
		this.addTalkId(new int[] { 30355 });
		this.addTalkId(new int[] { 30357 });
		this.addTalkId(new int[] { 30360 });
		addQuestItem(new int[] { SENTRY_BLADE1_ID, OLD_BRONZE_SWORD_ID, JENNIES_LETTER_ID, SENTRY_BLADE2_ID, SENTRY_BLADE3_ID });
	}
