...
public class _212_TrialOfDuty extends Quest implements ScriptFile
{
	...
	public _212_TrialOfDuty()
	{
		...
		addQuestItem(new int[] { 2634, 2635, 3027, 2637, 2636, 2639, 2641, 2643, 2644, 2645, 2646, 2640, 2642, 2638 });
	}
	...
	public String onTalk(final NpcInstance npc, final QuestState st)
	{
		...
		else if(npcId == 30109)
		{
			if(cond == 18 && st.getQuestItemsCount(2634) > 0L)
			{
				...
				{
					st.addExpAndSp(381288L, 24729L, true);
					st.giveItems(57, 69484L, Config.RATE_QUESTS_OCCUPATION_CHANGE);
