...
public class _226_TestOfHealer extends Quest implements ScriptFile
{
	...
	private static HashMap<Integer, Integer[]> DROPLIST;
	...
	public _226_TestOfHealer()
	{
		...
		addQuestItem(new int[] { 2810, 2811, 2812, 2813, 2814, 2815, 2816, 2817, 2818, 2819 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("30473_2"))
		{
			...
			st.giveItems(57, 233490L, Config.RATE_QUESTS_OCCUPATION_CHANGE);
			st.giveItems(2820, 1L);
			st.addExpAndSp(738283L, 50662L, true);
		...
		if(npcId == 30473)
		{
			...
			else if(cond == 23)
			{
				if(st.getQuestItemsCount(2813) == 0L)
				{
					...
					{
						st.addExpAndSp(32000L, 4100L, true);
	...
	@Override
	public void onPlayerEnter(final QuestState st)
	{
		final int cond = st.getCond();
		if(cond == 14 || cond == 16 || cond == 18)
			st.setCond(cond - 1);
	}
	...
	static
	{
		(_226_TestOfHealer.DROPLIST = new HashMap<Integer, Integer[]>()).put(27134, new Integer[] { 2, 3, 0 });
