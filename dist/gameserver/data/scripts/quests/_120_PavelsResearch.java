...
public class _120_PavelsResearch extends Quest implements ScriptFile
{
	...
	public _120_PavelsResearch()
	{
		...
		addQuestItem(new int[] { 8058, 8059, 8060, 8290, 8291, 8292 });
		this.addTalkId(new int[] { 32045 });
		this.addTalkId(new int[] { 32046 });
		this.addTalkId(new int[] { 32042 });
		this.addTalkId(new int[] { 32043 });
		this.addTalkId(new int[] { 32044 });
		this.addTalkId(new int[] { 32047 });
		this.addTalkId(new int[] { 32041 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32041-32.htm"))
		{
			...
			st.giveItems(6324, 1L, false);
			st.giveItems(57, 174160L, true);
			st.addExpAndSp(766070L, 60581L, true);
		...
		else if(event.equalsIgnoreCase("32045-02.htm"))
		{
			...
			if(player != null)
				npc.broadcastPacket(new L2GameServerPacket[] { new MagicSkillUse(npc, player, 5073, 5, 1500, 0L) });
		}
	...
	public String onTalk(final NpcInstance npc, final QuestState st)
	{
		...
		if(npcId == 32046)
		{
			final QuestState q = st.getPlayer().getQuestState(114);
			if(q == null)
				return htmltext;
			if(cond == 0)
			{
