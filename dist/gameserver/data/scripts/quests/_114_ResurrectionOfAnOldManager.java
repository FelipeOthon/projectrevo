...
public class _114_ResurrectionOfAnOldManager extends Quest implements ScriptFile
{
	...
	public _114_ResurrectionOfAnOldManager()
	{
		...
		this.addTalkId(new int[] { 32047 });
		this.addTalkId(new int[] { 32050 });
		this.addTalkId(new int[] { 32046 });
		this.addTalkId(new int[] { 31961 });
		addFirstTalkId(new int[] { 32046 });
		this.addKillId(new int[] { 27318 });
		addQuestItem(new int[] { 8090 });
		addQuestItem(new int[] { 8091 });
		addQuestItem(new int[] { 8287 });
		addQuestItem(new int[] { 8288 });
		addQuestItem(new int[] { 8289 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("pavel_atlanta_q0114_07.htm"))
		{
			...
			st.addExpAndSp(1846611L, 144270L, true);
		...
		{
			st.playSound(Quest.SOUND_ARMOR_WOOD_3);
			st.set("talk", "1");
		}
	...
	public String onFirstTalk(final NpcInstance npc, final Player player)
	{
		...
		if(npcId == 32046 && cond == 17)
		{
			...
			st.setCond(18);
			player.sendPacket(new ExShowScreenMessage("The radio signal detector is responding. A suspicious pile of stones catches your eye.", 4500, ExShowScreenMessage.ScreenMessageAlign.TOP_CENTER));
		}
		return "";
	}
	...
	public String onTalk(final NpcInstance npc, final QuestState st)
	{
		...
		if(npcId == 32041)
		{
			if(id == 1)
			{
				final QuestState Pavel = st.getPlayer().getQuestState(121);
				if(Pavel == null)
