...
public class _021_HiddenTruth extends Quest implements ScriptFile
{
	...
	{
		GhostofvonHellmann = Functions.spawn(new Location(51432, -54570, -3136).rnd(0, 50, false), 31524);
	}
	...
	public _021_HiddenTruth()
	{
		...
		this.addTalkId(new int[] { 31523 });
		this.addTalkId(new int[] { 31524 });
		this.addTalkId(new int[] { 31525 });
		this.addTalkId(new int[] { 31526 });
		this.addTalkId(new int[] { 31348 });
		this.addTalkId(new int[] { 31350 });
		this.addTalkId(new int[] { 31349 });
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("31328-05.htm"))
		{
			...
			st.addExpAndSp(131228L, 11978L, true);
		...
		{
			st.playSound(Quest.SOUND_HORROR2);
			st.set("cond", "2");
		...
		else if(event.equalsIgnoreCase("31524-06.htm"))
		{
			...
			st.playSound(Quest.SOUND_ITEM_DROP_EQUIP_ARMOR_CLOTH);
		else if(event.equalsIgnoreCase("31526-08.htm"))
		{
			st.playSound(Quest.SOUND_ED_CHIMES05);
			st.set("cond", "5");
		}
