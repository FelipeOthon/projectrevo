...
public class _044_HelpTheSon extends Quest implements ScriptFile
{
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equals("3") && st.getQuestItemsCount(168) > 0L)
		{
			htmltext = "pet_manager_lundy_q0044_0201.htm";
			st.takeItems(168, 1L);
			st.set("cond", "2");
		}
		else if(event.equals("4") && st.getQuestItemsCount(7552) >= 30L)
		{
		...
		else if(event.equals("5") && st.getQuestItemsCount(7553) > 0L)
		{
