...
public class _402_PathToKnight extends Quest implements ScriptFile
{
	...
	public _402_PathToKnight()
	{
		super(false);
		DROPLIST = new int[][] {
				{ 20775, 1168, 1169, 10, 100 },
				{ 27024, 1170, 1171, 12, 100 },
				{ 20038, 1172, 1173, 20, 100 },
				{ 20043, 1172, 1173, 20, 100 },
				{ 20050, 1172, 1173, 20, 100 },
				{ 20030, 1174, 1175, 20, 50 },
				{ 20027, 1174, 1175, 20, 100 },
				{ 20024, 1174, 1175, 20, 100 },
				{ 20103, 1176, 1177, 20, 40 },
				{ 20106, 1176, 1177, 20, 40 },
				{ 20108, 1176, 1177, 20, 40 },
				{ 20404, 1178, 1179, 10, 100 } };
		this.addStartNpc(30417);
		this.addTalkId(new int[] { 30031 });
		this.addTalkId(new int[] { 30037 });
		this.addTalkId(new int[] { 30039 });
		this.addTalkId(new int[] { 30289 });
		this.addTalkId(new int[] { 30311 });
		this.addTalkId(new int[] { 30332 });
		this.addTalkId(new int[] { 30379 });
		this.addTalkId(new int[] { 30653 });
		for(final int[] element : DROPLIST)
			this.addKillId(new int[] { element[0] });
		addQuestItem(new int[] { 1169, 1171, 1173, 1175, 1177, 1179 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		final Byte level = st.getPlayer().getLevel();
		...
		else if(event.equalsIgnoreCase("sir_karrel_vasper_q0402_13.htm") | event.equalsIgnoreCase("sir_karrel_vasper_q0402_14.htm") && squire > 0L && coin1 + coin2 + coin3 + coin4 + coin5 + coin6 >= 3L)
		{
	...
	public String onKill(final NpcInstance npc, final QuestState st)
	{
		final int npcId = npc.getNpcId();
		for(final int[] element : DROPLIST)
			if(st.getInt("cond") > 0 && npcId == element[0] && st.getQuestItemsCount(element[1]) > 0L && st.getQuestItemsCount(element[2]) < element[3] && Rnd.chance(element[4]))
			{
