...
{
	private static final short SCAVENGER_WERERAT_SKULL = 4326;
	private static final short TUREK_WARHOUND_TAIL = 4327;
	private static final short TYRANT_KINGPIN_HEART = 4328;
	private static final short TRISALIM_TARANTULAS_VENOM_SAC = 4329;
	private static final short MANUAL_OF_MANACLES = 4331;
	private static final short PENITENTS_MANACLES = 4425;
	private static final short PENITENTS_MANACLES1 = 4330;
	private static final short PENITENTS_MANACLES2 = 4426;
	private static final short SILVER_NUGGET = 1873;
	private static final short ADAMANTINE_NUGGET = 1877;
	private static final short BLACKSMITHS_FRAME = 1892;
	private static final short COKES = 1879;
	private static final short STEEL = 1880;
	...
	public int findPetLvl(final QuestState st)
	{
		...
		if(item == null)
			return 0;
		final Servitor pet = st.getPlayer().getServitor();
		if(pet == null)
	...
	public _422_RepentYourSins()
	{
		...
		this.addKillId(new int[] { 20039 });
		this.addKillId(new int[] { 20494 });
		this.addKillId(new int[] { 20193 });
		this.addKillId(new int[] { 20561 });
		addQuestItem(new int[] { 4326 });
		addQuestItem(new int[] { 4327 });
		addQuestItem(new int[] { 4328 });
		addQuestItem(new int[] { 4329 });
		addQuestItem(new int[] { 4331 });
		addQuestItem(new int[] { 4425 });
		addQuestItem(new int[] { 4330 });
	}
