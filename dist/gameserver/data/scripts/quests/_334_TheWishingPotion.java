...
public class _334_TheWishingPotion extends Quest implements ScriptFile
{
	...
	public _334_TheWishingPotion()
	{
		...
		this.addTalkId(new int[] { 30743 });
		this.addTalkId(new int[] { 30742 });
		for(int i = 0; i < _334_TheWishingPotion.DROPLIST_COND.length; ++i)
			this.addKillId(new int[] { _334_TheWishingPotion.DROPLIST_COND[i][2] });
		addQuestItem(new int[] { 3678, 3679, 3684, 3685, 3686, 3687, 3688, 3689, 3690, 3691 });
	}
		...
		for(int i = 0; i < _334_TheWishingPotion.DROPLIST_COND.length; ++i)
			if(cond == _334_TheWishingPotion.DROPLIST_COND[i][0] && npcId == _334_TheWishingPotion.DROPLIST_COND[i][2] && (_334_TheWishingPotion.DROPLIST_COND[i][3] == 0 || st.getQuestItemsCount(_334_TheWishingPotion.DROPLIST_COND[i][3]) > 0L))
				if(_334_TheWishingPotion.DROPLIST_COND[i][5] == 0)
					st.rollAndGive(_334_TheWishingPotion.DROPLIST_COND[i][4], _334_TheWishingPotion.DROPLIST_COND[i][7], _334_TheWishingPotion.DROPLIST_COND[i][6]);
				else if(st.rollAndGive(_334_TheWishingPotion.DROPLIST_COND[i][4], _334_TheWishingPotion.DROPLIST_COND[i][7], _334_TheWishingPotion.DROPLIST_COND[i][7], _334_TheWishingPotion.DROPLIST_COND[i][5], _334_TheWishingPotion.DROPLIST_COND[i][6]))
				{
					if(cond == 3)
						checkIngr(st);
					if(_334_TheWishingPotion.DROPLIST_COND[i][1] != cond && _334_TheWishingPotion.DROPLIST_COND[i][1] != 0)
					{
						st.set("cond", String.valueOf(_334_TheWishingPotion.DROPLIST_COND[i][1]));
						st.setState(2);
					}
				}
		final int DROP_CHANCE = Rnd.get(100) + 1;
	...
	static
	{
		DROPLIST_COND = new int[][] {
				{ 1, 2, 27139, 0, 3679, 1, 100, 1 },
				{ 3, 0, 20199, 0, 3684, 1, 15, 1 },
				{ 3, 0, 20078, 0, 3685, 1, 20, 1 },
				{ 3, 0, 20250, 0, 3686, 1, 35, 1 },
				{ 3, 0, 20227, 0, 3687, 1, 15, 1 },
				{ 3, 0, 20168, 0, 3688, 1, 30, 1 },
				{ 3, 0, 20087, 0, 3689, 1, 40, 1 },
				{ 3, 0, 20088, 0, 3689, 1, 40, 1 },
				{ 3, 0, 20192, 0, 3690, 1, 50, 1 },
				{ 3, 0, 20193, 0, 3690, 1, 50, 1 },
				{ 3, 0, 20248, 0, 3691, 1, 15, 1 },
				{ 3, 0, 20249, 0, 3691, 1, 25, 1 } };
	}
}
