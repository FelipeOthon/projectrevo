...
public class _241_PossessorOfaPreciousSoul1 extends Quest implements ScriptFile
{
	...
	public _241_PossessorOfaPreciousSoul1()
	{
		...
		this.addTalkId(new int[] { 31042 });
		this.addTalkId(new int[] { 30692 });
		this.addTalkId(new int[] { 31742 });
		this.addTalkId(new int[] { 31744 });
		this.addTalkId(new int[] { 31336 });
		this.addTalkId(new int[] { 31743 });
		this.addTalkId(new int[] { 31740 });
		this.addTalkId(new int[] { 31272 });
		this.addKillId(new int[] { 21154 });
		this.addKillId(new int[] { 27113 });
		this.addKillId(new int[] { 20244 });
		this.addKillId(new int[] { 20245 });
		this.addKillId(new int[] { 21511 });
		for(int npcKillId = 21508; npcKillId <= 21512; ++npcKillId)
			this.addKillId(new int[] { npcKillId });
		addQuestItem(new int[] { 7587, 7597, 7588, 7589, 7599, 7598 });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("31743-02.htm"))
		{
			...
			st.set("cond", "20");
		else if(event.equalsIgnoreCase("31272-04.htm"))
		{
			if(st.getQuestItemsCount(6029) >= 5L && st.getQuestItemsCount(6033) >= 1L)
			{
