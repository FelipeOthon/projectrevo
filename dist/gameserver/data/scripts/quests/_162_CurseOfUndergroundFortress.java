...
public class _162_CurseOfUndergroundFortress extends Quest implements ScriptFile
{
	...
	public _162_CurseOfUndergroundFortress()
	{
		...
		this.addTalkId(new int[] { 30147 });
		this.addKillId(new int[] { 20033 });
		this.addKillId(new int[] { 20345 });
		this.addKillId(new int[] { 20371 });
		this.addKillId(new int[] { 20463 });
		this.addKillId(new int[] { 20464 });
		this.addKillId(new int[] { 20504 });
