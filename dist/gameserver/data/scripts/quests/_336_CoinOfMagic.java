...
public class _336_CoinOfMagic extends Quest implements ScriptFile
{
	...
	public _336_CoinOfMagic()
	{
		...
		for(final int[] mob : _336_CoinOfMagic.DROPLIST)
			this.addKillId(new int[] { mob[0] });
		this.addKillId(_336_CoinOfMagic.UNKNOWN);
		this.addKillId(new int[] { 20645 });
		this.addKillId(new int[] { 20644 });
		addQuestItem(new int[] { 3811, 3812, 3813, 3814, 3815 });
	}
		...
		else
		{
			...
			if(h == 6)
			{
				...
				if(grade == 3)
					...
					st.set("cond", "11");
				st.playSound(Quest.SOUND_FANFARE_MIDDLE);
			}
			else
			{
	...
	static
	{
		BASIC_COINS = new int[] { 3472, 3482, 3490 };
		PROMOTE = new int[][] { new int[0], new int[0], { 3492, 3474, 3476, 3495, 3484, 3486 }, { 3473, 3485, 3491, 3475, 3483, 3494 } };
		EXCHANGE_LEVEL = new int[][] {
				{ 30696, 3 },
				{ 30673, 3 },
				{ 30183, 3 },
				{ 30165, 2 },
