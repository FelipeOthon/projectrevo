...
public class _228_TestOfMagus extends Quest implements ScriptFile
{
	...
	public _228_TestOfMagus()
	{
		...
		for(int i = 0; i < _228_TestOfMagus.DROPLIST_COND.length; ++i)
			this.addKillId(new int[] { _228_TestOfMagus.DROPLIST_COND[i][2] });
		...
		for(int i = 0; i < _228_TestOfMagus.DROPLIST_COND.length; ++i)
			if(cond == _228_TestOfMagus.DROPLIST_COND[i][0] && npcId == _228_TestOfMagus.DROPLIST_COND[i][2] && (_228_TestOfMagus.DROPLIST_COND[i][3] == 0 || st.getQuestItemsCount(_228_TestOfMagus.DROPLIST_COND[i][3]) > 0L))
				if(_228_TestOfMagus.DROPLIST_COND[i][5] == 0)
					st.rollAndGive(_228_TestOfMagus.DROPLIST_COND[i][4], _228_TestOfMagus.DROPLIST_COND[i][7], _228_TestOfMagus.DROPLIST_COND[i][6], _228_TestOfMagus.QuestProf);
				else if(st.rollAndGive(_228_TestOfMagus.DROPLIST_COND[i][4], _228_TestOfMagus.DROPLIST_COND[i][7], _228_TestOfMagus.DROPLIST_COND[i][7], _228_TestOfMagus.DROPLIST_COND[i][5], _228_TestOfMagus.DROPLIST_COND[i][6], _228_TestOfMagus.QuestProf) && _228_TestOfMagus.DROPLIST_COND[i][1] != cond && _228_TestOfMagus.DROPLIST_COND[i][1] != 0)
				{
					st.set("cond", String.valueOf(_228_TestOfMagus.DROPLIST_COND[i][1]));
					st.setState(2);
				}
	...
	static
	{
		DROPLIST_COND = new int[][] {
				...
				{ 5, 0, 20145, 2861, 2850, 20, 50, 2 },
				{ 5, 0, 20176, 2861, 2851, 10, 50, 2 },
				{ 5, 0, 20553, 2861, 2852, 10, 50, 2 },
				{ 5, 0, 20564, 2863, 2853, 10, 100, 2 },
				{ 5, 0, 20565, 2863, 2854, 10, 100, 2 },
				{ 5, 0, 20566, 2863, 2855, 10, 100, 2 },
				{ 5, 0, 27098, 2860, 2849, 5, 50, 1 },
				{ 5, 0, 20230, 2862, 2848, 20, 30, 2 },
				{ 5, 0, 20231, 2862, 2848, 20, 30, 2 },
				{ 5, 0, 20157, 2862, 2848, 20, 30, 2 },
				{ 5, 0, 20232, 2862, 2848, 20, 40, 2 },
				{ 5, 0, 20234, 2862, 2848, 20, 50, 2 } };
		_228_TestOfMagus.QuestProf = true;
	}
}
