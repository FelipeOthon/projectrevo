...
public class _101_SwordOfSolidarity extends Quest implements ScriptFile
{
	...
	public _101_SwordOfSolidarity()
	{
		...
		addQuestItem(new int[] { ALLTRANS_NOTE, HOWTOGO_RUINS, BROKEN_BLADE_TOP, BROKEN_BLADE_BOTTOM, ROIENS_LETTER, BROKEN_SWORD_HANDLE });
	}
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("blacksmith_alltran_q0101_07.htm"))
		{
			...
			st.getPlayer().addExpAndSp(25747L, 2171L, false, false);
