...
{
	static int MARK_OF_SUMMONER_ID;
	...
	static int GALATEAS_LETTER_ID;
	static int BEGINNERS_ARCANA_ID;
	...
	static HashMap<Integer, Integer[]> DROPLIST_LARA;
	static String[] STATS;
	static int[][] LISTS;
	static HashMap<Integer, Integer[]> DROPLIST_SUMMON;
	static HashMap<Integer, String> DROPLIST_SUMMON_VARS;
	...
	{
		super(false);
		this.addStartNpc(_230_TestOfSummoner.Galatea);
	...
	public String onEvent(final String event, final QuestState st, final NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("30634-08.htm"))
		{
			for(final String var : _230_TestOfSummoner.STATS)
				if(!var.equalsIgnoreCase("Arcanas"))
					if(!var.equalsIgnoreCase("Lara_Part"))
						st.set(var, "1");
			st.setState(2);
			...
			if(npcId == 30634)
			{
				...
				else if(step == 2)
				{
					if(Arcanas == 6)
					{
						...
						{
							st.addExpAndSp(832247L, 57110L, true);
							st.giveItems(57, 150480L, Config.RATE_QUESTS_OCCUPATION_CHANGE);
					...
					if(i[0] == npcId)
					{
						...
						if(step > 1)
							...
							else if(st.getQuestItemsCount(k[1]) > 0L)
							{
								...
								st.addNotifyOfDeath(st.getPlayer().getServitor());
	...
	@Override
	public String onDeath(final Creature killer, final Playable victim, final QuestState st)
	{
		if(killer == null || victim == null)
			return null;
		final int npcId = killer.getNpcId();
		if((victim == st.getPlayer() || victim == st.getPlayer().getServitor()) && npcId >= 27102 && npcId <= 27107)
		{
	...
	public String onAttack(final NpcInstance npc, final QuestState st)
	{
		...
		if(npcId >= 27102 && npcId <= 27107)
		{
			...
			if(st.getQuestItemsCount(i[2]) != 0L)
				return null;
			final Servitor summon = st.getPlayer().getServitor();
	...
	static
	{
		_230_TestOfSummoner.MARK_OF_SUMMONER_ID = 3336;
		...
		_230_TestOfSummoner.GALATEAS_LETTER_ID = 3352;
		_230_TestOfSummoner.BEGINNERS_ARCANA_ID = 3353;
		...
		_230_TestOfSummoner.SUMMONERS = new int[][] {
				{ 30635, _230_TestOfSummoner.ALMORS_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY1_ID },
				{ 30636, _230_TestOfSummoner.CAMONIELL_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY2_ID },
				{ 30637, _230_TestOfSummoner.BELTHUS_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY3_ID },
				{ 30638, _230_TestOfSummoner.BASILLIA_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY4_ID },
				{ 30639, _230_TestOfSummoner.CELESTIEL_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY5_ID },
				{ 30640, _230_TestOfSummoner.BRYNTHEA_ARCANA_ID, _230_TestOfSummoner.CRYSTAL_OF_VICTORY6_ID } };
		(_230_TestOfSummoner.NAMES = new HashMap<Integer, String>()).put(30635, "Almors");
		...
		(_230_TestOfSummoner.DROPLIST_LARA = new HashMap<Integer, Integer[]>()).put(20555, new Integer[] {
				1,
				80,
				_230_TestOfSummoner.SAC_OF_REDSPORES_ID });
		...
		_230_TestOfSummoner.STATS = new String[] {
				"cond",
				"step",
				"Lara_Part",
				"Arcanas",
				...
				"Basilla",
				"Almors" };
		_230_TestOfSummoner.LISTS = new int[][] {
				new int[0],
				{ _230_TestOfSummoner.LARS_LIST1_ID, _230_TestOfSummoner.SAC_OF_REDSPORES_ID, _230_TestOfSummoner.LETOLIZARDMAN_AMULET_ID },
				{ _230_TestOfSummoner.LARS_LIST2_ID, _230_TestOfSummoner.KARULBUGBEAR_TOTEM_ID, _230_TestOfSummoner.SHARDS_OF_MANASHEN_ID },
				{ _230_TestOfSummoner.LARS_LIST3_ID, _230_TestOfSummoner.CRIMSON_BLOODSTONE_ID, _230_TestOfSummoner.BREKAORC_TOTEM_ID },
				{ _230_TestOfSummoner.LARS_LIST4_ID, _230_TestOfSummoner.TUSK_OF_WINDSUS_ID, _230_TestOfSummoner.TALONS_OF_TYRANT_ID },
				{ _230_TestOfSummoner.LARS_LIST5_ID, _230_TestOfSummoner.WINGS_OF_DRONEANT_ID, _230_TestOfSummoner.FANGS_OF_WYRM_ID } };
		(_230_TestOfSummoner.DROPLIST_SUMMON = new HashMap<Integer, Integer[]>()).put(27102, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS1_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS1_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL1_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT1_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY1_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON.put(27103, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS2_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS2_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL2_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT2_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY2_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON.put(27104, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS3_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS3_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL3_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT3_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY3_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON.put(27105, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS4_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS4_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL4_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT4_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY4_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON.put(27106, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS5_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS5_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL5_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT5_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY5_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON.put(27107, new Integer[] {
				_230_TestOfSummoner.CRYSTAL_OF_PROGRESS6_ID,
				_230_TestOfSummoner.CRYSTAL_OF_INPROGRESS6_ID,
				_230_TestOfSummoner.CRYSTAL_OF_FOUL6_ID,
				_230_TestOfSummoner.CRYSTAL_OF_DEFEAT6_ID,
				_230_TestOfSummoner.CRYSTAL_OF_VICTORY6_ID });
		_230_TestOfSummoner.DROPLIST_SUMMON_VARS = new HashMap<Integer, String>();
