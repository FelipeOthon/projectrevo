...
public class _221_TestimonyOfProsperity extends Quest implements ScriptFile
{
	...
	public _221_TestimonyOfProsperity()
	{
		...
		for(int i = 0; i < _221_TestimonyOfProsperity.DROPLIST_COND.length; ++i)
			this.addKillId(new int[] { _221_TestimonyOfProsperity.DROPLIST_COND[i][2] });
	...
	public String onTalk(final NpcInstance npc, final QuestState st)
	{
		...
		if(npcId == 30104)
		{
			...
			else if(cond == 9)
			{
				...
				{
					st.addExpAndSp(599979L, 40040L, true);
					st.giveItems(57, 108841L, Config.RATE_QUESTS_OCCUPATION_CHANGE);
		...
		for(int i = 0; i < _221_TestimonyOfProsperity.DROPLIST_COND.length; ++i)
			if(cond == _221_TestimonyOfProsperity.DROPLIST_COND[i][0] && npcId == _221_TestimonyOfProsperity.DROPLIST_COND[i][2] && (_221_TestimonyOfProsperity.DROPLIST_COND[i][3] == 0 || st.getQuestItemsCount(_221_TestimonyOfProsperity.DROPLIST_COND[i][3]) > 0L))
				if(_221_TestimonyOfProsperity.DROPLIST_COND[i][5] == 0)
					st.rollAndGive(_221_TestimonyOfProsperity.DROPLIST_COND[i][4], _221_TestimonyOfProsperity.DROPLIST_COND[i][7], _221_TestimonyOfProsperity.DROPLIST_COND[i][6], _221_TestimonyOfProsperity.QuestProf);
				else if(st.rollAndGive(_221_TestimonyOfProsperity.DROPLIST_COND[i][4], _221_TestimonyOfProsperity.DROPLIST_COND[i][7], _221_TestimonyOfProsperity.DROPLIST_COND[i][7], _221_TestimonyOfProsperity.DROPLIST_COND[i][5], _221_TestimonyOfProsperity.DROPLIST_COND[i][6], _221_TestimonyOfProsperity.QuestProf) && _221_TestimonyOfProsperity.DROPLIST_COND[i][1] != cond && _221_TestimonyOfProsperity.DROPLIST_COND[i][1] != 0)
				{
					st.set("cond", String.valueOf(_221_TestimonyOfProsperity.DROPLIST_COND[i][1]));
					st.setState(2);
				}
	...
	static
	{
		...
		_221_TestimonyOfProsperity.QuestProf = true;
	}
}
