...
public class GeometryUtils
{
	...
	public static double calculateDistance(Point3D a, Point3D b, boolean includeZAxis)
	{
	...
	public static Point2D getNearestPointOnLine(Point2D p1, Point2D p2, int x, int y)
	{
		...
		int r1 = (int) calculateDistance(p1.x, p1.y, x, y);
		Point2D np1 = getNearestPointOnCircle(p1, r1, p2.x, p2.y);
		int r2 = (int) calculateDistance(p2.x, p2.y, x, y);
