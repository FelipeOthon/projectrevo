...
public class RequestServerLogin extends L2LoginClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(gs.isAccessWithPaOnly() && account.getAccessLevel() < 100 && (account.getBonus() <= 0 || account.getBonusExpire() < TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis())))
		{
			client.close(PlayFail.REASON_GAME_TIME_EXPIRED);
			return;
		}
