...
public class GameServer
{
	...
	private boolean _accessWithPaOnly;
	...
	public boolean isAccessWithPaOnly()
	{
		return _accessWithPaOnly;
	}

	public void setAccessWithPaOnly(boolean accessWithPaOnly)
	{
		_accessWithPaOnly = accessWithPaOnly;
	}
